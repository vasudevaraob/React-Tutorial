...
import com.springboot.thymeleaf.dao.EmployeeServiceImpl;
...
public class EmployeeController {
	...
	/*
	 * @GetMapping("/a") public String viewHomePage(Model model) {
	 * 
	...
	/*
	 * @GetMapping("/") public String backtoHomePage(Model model) { return
